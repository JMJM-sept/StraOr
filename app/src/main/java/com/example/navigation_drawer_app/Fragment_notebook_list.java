...
public class Fragment_notebook_list extends Fragment {

    private ItemAdapter adapter;

    public Fragment_notebook_list() {}
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btnBack.setOnClickListener(v ->
                NavHostFragment.findNavController(Fragment_notebook_list.this).popBackStack()
        );

        RecyclerView rv = view.findViewById(R.id.rvNotebook);
        ...
        adapter = new ItemAdapter(new ItemAdapter.Listener() {
            ...
            public void onEdit(Item item) {
                Bundle b = new Bundle();
                b.putString("tipo", "Notebook");
                b.putLong("id", item.id);

                NavHostFragment.findNavController(Fragment_notebook_list.this)
            ...
            public void onDelete(Item item) {
                ...
                adapter.setItems(db.getItemsByTipo("Notebook"));
            }
        });
        ...
        fabAdd.setOnClickListener(v -> {
            ...
            bundle.putString("tipo", "Notebook");
